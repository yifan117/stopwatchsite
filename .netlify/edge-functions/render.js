...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-e1305a64.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-e1305a64.js", "_app/immutable/chunks/index-1fab3784.js"];
...
var css$1, OtherStopwatchTANDB, css2, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_chunks();
    css$1 = {
      code: ".colon.svelte-10wlj39{font-weight:1000;font-size:10rem;height:200px;width:50px;display:flex;align-items:center;justify-content:center}.contents.svelte-10wlj39{display:flex;flex-direction:column;align-items:center;justify-content:space-evenly;height:100vh;width:100vw;border-radius:5px;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif}.textfield.svelte-10wlj39{height:45vh;width:100vw;display:flex;align-items:center;justify-content:space-evenly;font-family:inherit}.counter.svelte-10wlj39{height:190px;display:flex;align-items:center;justify-content:center}.timeUnit.svelte-10wlj39{width:230px;height:270px;display:flex;flex-direction:column;align-items:center;justify-content:space-evenly;font-weight:1000;font-size:10rem}small.svelte-10wlj39{font-size:large}.buttons.svelte-10wlj39{display:flex;flex-direction:row;align-items:center;justify-content:space-evenly;width:30vw;height:10vh;margin-top:5vh;border-radius:5px}button.svelte-10wlj39{background-color:#A9A9A9;border-radius:50px;height:8vh;width:8vw;display:flex;align-items:center;align-content:center;justify-content:center;font-size:1.5rem;font-weight:600;font-family:inherit;border:10px}button.svelte-10wlj39:hover{opacity:50%;border-color:black}",
      map: null
    };
    OtherStopwatchTANDB = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"contents svelte-10wlj39"}"><div class="${"textfield svelte-10wlj39"}"><div class="${"timeUnit svelte-10wlj39"}"><div class="${"counter svelte-10wlj39"}">${`0${escape(minutes)}`}</div>
    
                <small class="${"svelte-10wlj39"}">Minutes</small></div>
    
            <div class="${"colon svelte-10wlj39"}">:
            </div>
    
            <div class="${"timeUnit svelte-10wlj39"}"><div class="${"counter svelte-10wlj39"}">${`0${escape(seconds)}`}</div>
    
                <small class="${"svelte-10wlj39"}">Seconds</small></div>
    
            <div class="${"colon svelte-10wlj39"}">:
            </div>    
    
            <div class="${"timeUnit svelte-10wlj39"}"><div class="${"counter svelte-10wlj39"}">${`0${escape(ms)}`}</div>
    
                    <small class="${"svelte-10wlj39"}">Centiseconds</small></div></div>
    
        <div class="${"buttons svelte-10wlj39"}"><button class="${"svelte-10wlj39"}">${escape(state)}</button>
    
            <button class="${"svelte-10wlj39"}">Reset
            </button></div>
    </div>`;
    });
    css2 = {
      code: ".body.svelte-1gp0rfy{display:flex;flex-direction:column;align-items:center;justify-content:space-evenly;height:100vh;width:100vw;background-color:#33292956;border-radius:5px}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css2);
      return `<title>Yifan&#39;s Stopwatch</title>
    
    <div class="${"body svelte-1gp0rfy"}">
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-1b69488d.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-1b69488d.js", "_app/immutable/chunks/index-1fab3784.js"];
    stylesheets3 = ["_app/immutable/assets/_page-9f3198e1.css"];
  }
});
